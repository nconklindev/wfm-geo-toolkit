    ...
    <div class="flex flex-col items-center justify-between md:flex-row">
        ...
        <div>
            <nav class="flex items-center gap-6">
                <a
                    href="#features"
                    class="text-sm text-muted transition-colors hover:text-zinc-900 dark:hover:text-zinc-200"
                >
                    Features
                </a>
                <a href="#" class="text-sm text-muted transition-colors hover:text-zinc-900 dark:hover:text-zinc-200">
                    Support
                </a>
                <a href="#" class="text-sm text-muted transition-colors hover:text-zinc-900 dark:hover:text-zinc-200">
                    Privacy
