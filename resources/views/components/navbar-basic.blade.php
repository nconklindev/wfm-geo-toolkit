<header class="w-full mx-auto max-w-7xl px-6 lg:px-8 py-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <svg class="w-10 h-10 text-accent" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <flux:navbar {{ $attributes }}>
            ...
            @auth
                <flux:navbar.item href="{{ url('/dashboard') }}"
                >
                    Dashboard
                </flux:navbar.item>
            @else
