<div class="space-y-6">
    ...
    <x-api-endpoint-header
        heading="Retrieve Known IP Addresses"
        method="GET"
        wfm-endpoint="/api/v1/commons/known_ip_addresses"
    />
        ...
        <div class="space-y-4">
            ...
            <div class="rounded-lg bg-zinc-50 p-4 dark:bg-zinc-800/50">
                ...
                <ul class="list-inside list-disc space-y-1 text-sm">
                    <li>Retrieves all Known IP Addresses</li>
                    <li>The associated Function Access Control Point is SETUP</li>
