<div class="space-y-6 lg:col-span-1" wire:cloak>
    ...
    <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
        ...
        <div class="flex flex-col space-y-2">
            <x-filter-button query="filter" filter="all">
                <x-slot:icon>
                    <flux:icon.inbox-stack class="size-5" variant="solid" />
                </x-slot>
                All Notifications
            </x-filter-button>
            <x-filter-button query="filter" filter="unread">
                <x-slot:icon>
                    <flux:icon.envelope class="size-5" variant="solid" />
                </x-slot>
                Unread
            </x-filter-button>
            <x-filter-button query="filter" filter="read">
                <x-slot:icon>
    ...
    <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
        ...
        <div class="flex flex-col space-y-2">
            <x-filter-button query="status" filter="all">
                <x-slot:icon>
                    <flux:icon.chart-pie class="size-5" variant="solid" />
                </x-slot>
                All Types
            </x-filter-button>
            {{-- <x-filter-button query="status" filter="Needs Attention"> --}}
            {{-- <x-slot:icon> --}}
            {{-- <flux:icon.exclamation-circle class="size-5" variant="solid" /> --}}
            {{-- </x-slot> --}}
            {{-- Needs Attention --}}
            {{-- </x-filter-button> --}}
            <x-filter-button query="status" filter="Possible Conflict">
                <x-slot:icon>
                    <flux:icon.exclamation-triangle class="size-5" variant="solid" />
                </x-slot>
                Possible Conflict
            </x-filter-button>
            <x-filter-button query="status" filter="Notification">
                <x-slot:icon>
