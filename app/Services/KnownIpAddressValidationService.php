...
class KnownIpAddressValidationService
{
    ...
    /**
     * Send a notification to the user about IP address issues.
     */
    ...
    {
        $criticalIssues = array_filter($issues, static fn ($issue) => $issue['severity'] === 'critical');
        $warningIssues = array_filter($issues, static fn ($issue) => $issue['severity'] === 'warning');
