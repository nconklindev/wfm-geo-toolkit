...
return [
    ...
    // Disable Sentry entirely in local/testing environments
    ...
    // Ignore health checks and common endpoints to save quota
    'ignore_transactions' => [
        // Ignore Laravel's default health URL
        '/up',
        // Add other health check endpoints
        '/health',
        '/ping',
        // Ignore favicon requests
        '/favicon.ico',
        // Ignore common bot requests
        '/robots.txt',
        '/sitemap.xml',
    ],
